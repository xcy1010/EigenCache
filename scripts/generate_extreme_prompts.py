...
def main():
    prompts = [
        # --- Group 1: Dense text and typography (most prone to spelling errors) ---
        ...
        # --- Group 2: High-frequency repetitive textures (most prone to blur/moire patterns) ---
        ...
        # --- Group 3: Complex lighting and refraction (most prone to losing highlights) ---
        ...
        # --- Group 4: Complex spatial structures and geometry (most prone to deformation) ---
